...
const innovations = [
  {
    ...
    description: "A student-built IoT device to automate water supply in school gardens.",
  },
  {
    title: "Biogas from Waste",
    description: "Innovation by our science students to convert organic waste into clean energy.",
  },
  {
    title: "Solar-Powered Charger",
    description: "Portable solar charger made from recycled materials for mobile devices.",
  },
  {
    title: "AI-based Class Scheduler",
    description: "A software solution built by students to automate school timetable generation.",
  },
];
    ...
    <>
      ...
      >
        <div style={{ width: "100%", maxWidth: "1200px" }}>
          ...
          >
            {innovations.map(({ title, description }, index) => (
              <div
                key={index}
                style={{
