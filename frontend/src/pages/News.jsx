...
// Navbar Component (same as previous)
const Navbar = () => {
  const navItems = [
    { label: "HOME", path: "/" },
...
const newsData = [
  {
    title: "Mid-Term Exams Begin Next Week",
    date: "June 10, 2025",
    description: "All students are informed that mid-term examinations will start from June 17. Please check the timetable.",
  },
  {
    title: "New ICT Lab Inaugurated",
    date: "June 3, 2025",
    description: "GIKONKO TSS has officially opened a new ICT laboratory to support students in digital learning.",
  },
  {
    title: "Student Innovation Fair 2025",
    date: "May 25, 2025",
    description: "Our students showcased their projects in a fair attended by industry professionals and educators.",
  },
  {
    title: "Parents Meeting Scheduled",
    date: "May 20, 2025",
    description: "The administration invites all parents to a meeting on June 1st to discuss academic progress and discipline.",
  },
];
    ...
    <>
      ...
      >
        <div style={{ width: "100%", maxWidth: "1200px" }}>
          ...
          >
            {newsData.map(({ title, date, description }, index) => (
              <div
                key={index}
                style={{
              ...
              >
                ...
                <p style={{ fontSize: "0.85rem", color: "#aaa", marginBottom: "0.5rem" }}>{date}</p>
